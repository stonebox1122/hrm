...
import com.stone.hrm.service.AdministratorService;
...
public class AdministratorController {
	...
	public Result findAll(){
		return new Result(true, StatusCode.OK,"查询成功",administratorService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,StatusCode.OK,"查询成功",administratorService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(true,StatusCode.OK,"查询成功",  new PageResult<Administrator>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(true,StatusCode.OK,"查询成功",administratorService.findSearch(searchMap));
    }
